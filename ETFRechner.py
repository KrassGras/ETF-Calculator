...
st.write("Berechne die monatliche Sparrate, die du brauchst, um dein Vermögensziel zu erreichen. Die einmalige Anlage wird von oben übernommen.")
...
if ziel > 0:
    if zt <= 0:
        st.write("Bitte eine Ziel-Laufzeit angeben.")
    else:
        wachstum = (1 + zr) ** zt
        if zr == 0:
